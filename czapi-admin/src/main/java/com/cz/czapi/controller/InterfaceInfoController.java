...
import com.cz.czapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.cz.czapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
...
import com.cz.czapicommon.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
   ...
   /* @Resource
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            String invokeResult = czApiClient.invokeInterface(requestParams, url, method);
